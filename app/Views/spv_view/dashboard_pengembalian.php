                                ...
                                <table class="table table-bordered table-striped table-hover js-exportable" id= "laporan" >
                                    ...
                                    <tr>
                                        ...
                                        <td><?php 
                                            ...
                                            {
                                            ?>
                                             <a href="<?= base_url('/spv/index_dashboard_pengembalian/approvePengembalian/'.$lp->id)?>" class="btn btn-primary waves-effect">
                                                
                                                <span>APPROVE</span>
                                            </a>
                                            <a href="<?= base_url('/spv/index_dashboard_pengembalian/rejectPengembalian/'.$lp->id)?>"class="btn btn-danger waves-effect">
                                                    <span>REJECT</span>
                                            </a>
                                            <?php
                                            }else if($lp->status == 1)
