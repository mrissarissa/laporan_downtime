                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id = "form_laporan" name = "form_laporan"  action="<?= base_url('gl/dashboard/savePengembalian');?>"  method ="post" accept-charset="utf-8">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="email_address">Tanggal Pengembalian</label>
                                            <div class="form-line">
                                                <input type="text" class="form-control" id = "tgl_pengembalian" name = "tgl_pengembalian" value="<?= date("Y-m-d") ?>" readonly required/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                            <select class="form-control" id="nm_barang" name="nm_barang"  data-live-search="true">
                                                <?php
                                                foreach($stock as $st):
                                                ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="email_address">Kondisi Barang </label>
                                            <div class="form-line">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="email_address">Keterangan Barang </label>
                                            <div class="form-line">
                                                <textarea class="form-control" name="keterangan_barang"  id="keterangan_barang"></textarea>
                                            </div>
                                        </div>
