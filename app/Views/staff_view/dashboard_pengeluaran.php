                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <a  href="#" class="btn btn-default waves-effect m-r-20"  data-toggle="modal" data-target="#defaultModal">Download Pengeluaran Barang</a>
                                ...
                                <table class="table table-bordered table-striped table-hover js-exportable" id= "laporan" >
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $lp->qty_keluar_barang?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="download" method="get" action = "<?= base_url('/staff/exportPengeluaran')?>">
                            <?= csrf_field(); ?>
