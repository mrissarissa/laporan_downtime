                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <a  href="<?= base_url('/staff/exportBarang')?>" class="btn btn-default waves-effect m-r-20" >Download Master Barang</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-exportable" id= "laporan" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('staff/editBarang/'.$brg->id);?>" class="btn btn-info btn-sm btn-edit" >Edit</a>
                                            <a href="<?= base_url('staff/deleteBarang/'.$brg->id);?>" class="btn btn-danger btn-sm " >Delete</a>
                                        </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="download" method="get" action = "<?= base_url('staff/saveBarang');?>">
                            <?= csrf_field(); ?>
